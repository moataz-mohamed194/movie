...
class SavedMovie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: BlocBuilder<UIBloc, bool>(builder: (context, state0) {
        if (state0 == true) {
                          ...
                          itemBuilder: (context, index) {
                            return SavedCard(
                              ...
                              movieImage: state.data[index]['movieImgPoster']
                                  .toString(),
                              movieOverview:
                                  state.data[index]['movieOverview'].toString(),
                              movieImgCover:
                                  state.data[index]['movieImgCover'].toString(),
                              movieRate:
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => DetailsMovie(
                                              ...
                                              imageCover: state.data[index]
                                                      ['movieImgCover']
                                                  .toString(),
                                              imagePoster: state.data[index]
                                                      ['movieImgPoster']
                                                  .toString(),
                                              rate: state.data[index]
                                                      ['movieRate']
                                                  .toString(),
                                            )));
                              },
                              deleteFunction: () {
                                sql.add(GetSavedMoviesAfterDelete(
                                    state.data[index]['movieId'].toString()));
                              },
                            );
                          }),
                    );
